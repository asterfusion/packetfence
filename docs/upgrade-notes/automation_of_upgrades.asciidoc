...
This section covers bases automation of upgrades available since PacketFence 11.0.0 on the same OS.
...
* Automation can contain **pre-upgrade steps** defined in the following document.
...
* An exportable backup of your configuration is performed before doing upgrade
