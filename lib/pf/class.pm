...
sub class_add {
    ...
    my %values;
    @values{qw(security_event_id description auto_enable max_enables grace_period window vclose priority template max_enable_url redirect_url button_text enabled vlan target_category delay_by external_command rest_url)} = @_;
