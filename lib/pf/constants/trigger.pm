...
our @EXPORT_OK = qw(
        ...
        $TRIGGER_TYPE_DEVICE_ONLINE
        $TRIGGER_TYPE_MAX_ONLINE
...
Readonly::Scalar our $TRIGGER_TYPE_MAX_ONLINE => 'max_online_limit';
Readonly::Scalar our $TRIGGER_TYPE_DEVICE_ONLINE => 'device_online';
