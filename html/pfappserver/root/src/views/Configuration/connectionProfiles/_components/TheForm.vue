  ...
  >
    <b-tabs>
      <base-form-tab :title="$i18n.t('Settings')" active>
        ...
        <form-group-mac-auth-recompute-role-from-portal
        ...
        <form-group-advanced-filter v-show="!isDefault"
                                    ...
                                    :text="$i18n.t('The advanced filter acts as an additional filter that is combined with the basic filters and respects all/any')"
        />
      ...
      <base-form-tab :title="$i18n.t('Captive Portal')">
        ...
        <form-group-access-registration-when-registered
